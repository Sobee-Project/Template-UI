                  ...
                  <Table size='small' sx={{ width: '95%' }}>
                    ...
                    >
                      <TableRow>
                        ...
                        <TableCell>
                          <Typography sx={{ color: 'text.secondary' }}>Wingsinvent</Typography>
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>
                        ...
                        <TableCell>
                          <Typography sx={{ color: 'text.secondary' }}>wing@gmail.com</Typography>
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>
                        ...
                        <TableCell>
                          <Typography sx={{ color: 'text.secondary' }}>TAX-123467</Typography>
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>
                        ...
                        <TableCell>
                          <Typography sx={{ color: 'text.secondary' }}>RFC754K77</Typography>
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>
              ...
              <form>
                <Grid container spacing={6}>
                  <Grid item xs={12} sm={6}>
                    <CustomTextField
                      fullWidth
                      defaultValue='Wingsinvent'
                      label='Company Name'
                      placeholder='Wingsinvent'
                    />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <CustomTextField
